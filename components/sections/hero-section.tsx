        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                MIST Mongol Barota is Bangladesh's premier Mars rover team, pushing the boundaries of space exploration
                through innovative engineering and unwavering determination.
              </p>
            </div>
            ...
            >
              {["URC 2021 Champions", "ARC 2024 Runners-up", "Highest Scoring South Asian Team"].map(
                (achievement, index) => (
                  <div
                    key={achievement}
          ...
          >
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <Image
                src="/mars-rover-with-robotic-arm-on-red-planet-surface-.jpg"
              ...
              >
                ...
                <div className="text-xs font-medium mt-1">Precision Navigation</div>
              </div>
